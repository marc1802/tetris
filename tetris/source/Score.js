...
export default class Score {
     ...
     * @param {Number} drop - Amount of cells the Tetrimino dropped before crashig the bottom
     * @returns {Void}
     */
    piece(drop) {
     ...
     * @param {Number} amount - Amount of lines completed is on move
     * @returns {Void}
     */
    line(amount) {
    ...
    /**
     * Increases the score
     * @param {Number} amount - Amount of lines completed is one move
     * @returns {Void}
     */
    addScore(amount) {
